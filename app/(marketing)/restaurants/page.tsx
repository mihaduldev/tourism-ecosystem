...
const restaurants = [
  ...
  { id: "r4", name: "Café de Flore", cuisine: "Continental & Coffee", location: "Dhanmondi, Dhaka", rating: 4.3, reviews: 245, priceRange: "৳৳", hours: "8am–10pm", image: "☕", features: ["WiFi", "AC", "Outdoor Seating", "Desserts"], tables: 10, seats: 35, reservable: false },
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">{restaurants.length} restaurants available for reservation</p>
        </div>
        <div className="flex gap-2">
          <select className="px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white">
            <option>All Cuisine</option><option>Bengali</option><option>Indian</option><option>Chinese</option><option>Continental</option>
          </select>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-3 shadow-sm flex flex-col sm:flex-row gap-2 mb-6">
        <div className="relative flex-1">
          ...
          <input type="text" placeholder="Search restaurant or cuisine..." className="w-full pl-9 pr-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-500" />
        </div>
